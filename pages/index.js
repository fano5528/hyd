...
export default function Home({categories}) {
  return (
    ...
    <div className="w-sgrid sm:w-grid mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mt-4 sm:mt-6">
      <Card img="/foco.jpg" name="test" price="599" id="price_1MpN9wJ8K7osZc8AweBLDNnY"/>
      <Card img="/foco.jpg" name="El foco más perrón" price="999" id="price_1MpN9OJ8K7osZc8A4Le9g6i2"/>
      <Card img="/foco.jpg" name="test" price="599" id="price_1MpN9wJ8K7osZc8AweBLDNnY"/>
    </div>
